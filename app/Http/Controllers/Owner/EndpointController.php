...
class EndpointController extends Controller {
    ...
    public function get($website) {
        $data['data']   = (new Plan)->setConnection(config()->get('web.db.tsub'))->active()->where('website', $website)->firstorfail();
    ...
    public function post($website) {
        $plan   = (new Plan)->setConnection(config()->get('web.db.tsub'))->active()->where('website', $website)->firstorfail();
        $input  = request()->input();
