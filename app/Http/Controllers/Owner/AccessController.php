...
class AccessController extends Controller {
    ...
    public function get($website) {
        $data['data']   = (new Plan)->setConnection(config()->get('tswirl.db.tsub'))->active(now())->where('website', $website)->firstorfail();
    ...
    public function post($website) {
        $plan   = (new Plan)->setConnection(config()->get('tswirl.db.tsub'))->active(now())->where('website', $website)->firstorfail();
        $input  = request()->input();
