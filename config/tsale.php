...
return [
    'scopes'    => [
        ...
        'tsale.report.catalog'       => 'Melihat report trend produk',
        'tsale.report.palate'        => 'Melihat report preferensi produk',
        'tsale.report.sold'          => 'Melihat report penjualan (produk)',
        'tsale.report.category'      => 'Melihat report penjualan (kategori)',
        'tsale.report.customer'      => 'Melihat report pelanggan',
        'tsale.report.payment'       => 'Melihat report penjualan (pembayaran)',
